    ...
    <>
      ...
      <HeroSection client:load>
        <div class="w-full flex flex-col">
          <button onClick$={()=>null} class="group w-full max-w-xl focus:ring-primary-500 duration-200 outline-none rounded-xl flex items-center justify-between hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-800 dark:focus:bg-gray-800 transition-all gap-2 px-4 py-3 h-[45px] ring-2 ring-gray-300 dark:ring-gray-700 mx-auto text-gray-900/70 dark:text-gray-100/70 bg-white dark:bg-black">
            ...
            <div class="flex items-center">
              <span class="flex items-center text-base font-title font-bold">
                ...
                {/* <svg xmlns="http://www.w3.org/2000/svg"  class="group-focus:block hidden text-green-00 size-6 flex-shrink-0" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="m4 12.9l3.143 3.6L15 7.5" opacity=".5"/><path d="m20 7.563l-8.571 9L11 16"/></g></svg> */}
                <svg xmlns="http://www.w3.org/2000/svg" class="group-focus:block hidden text-green-500 size-6 flex-shrink-0" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="m9.55 15.15l8.475-8.475q.3-.3.7-.3t.7.3t.3.713t-.3.712l-9.175 9.2q-.3.3-.7.3t-.7-.3L4.55 13q-.3-.3-.288-.712t.313-.713t.713-.3t.712.3z"/></svg>              </span>
            </div>
          </button>
