                    ...
                    <>
                        {userSubscription.value == "Pro" ? (
                            ...
                            <div class="w-full animate-fade-in opacity-0 transition-all duration-200 ease-in relative">
                                ...
                                <div class="hover:border-[#99CCFF]/70 border-gray-600 bg-white dark:bg-black z-[5] relative w-full transition-all duration-300 border-[2px] h-14 rounded-xl px-4 gap-2 flex items-center justify-between overflow-hidden outline-none disabled:opacity-50">
