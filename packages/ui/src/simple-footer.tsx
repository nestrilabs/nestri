...
export default component$(({ class: className }: Props) => {
    return (
        <footer class={cn("w-full max-w-[750px] mx-auto z-20 pb-16 text-sm text-gray-500 ", className)}>
            <hr class="border-none w-full h-[1.5px] bg-gray-700" />
            <div class="py-4 px-3 flex justify-between flex-wrap">
                <div class="flex gap-4 items-center h-6 leading-none -ml-3">
                    <Link href="/" class="text-gray-600 text-lg hover:text-gray-400 transition-all duration-200 -mt-1">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    <Link href="/about" class="hover:text-gray-300 transition-all duration-200">
                        About Us
                    </Link>
                    <Link href="/pricing" class="hover:text-gray-300 transition-all duration-200">
                        Pricing
                    </Link>
                    <Link href="/docs" class="hover:text-gray-300 transition-all duration-200">
                        Docs
                    </Link>
                </div>
                <div class="flex items-center [&_svg]:size-5 -mr-3 gap-4">
                    <Link href="mailto:hi@nestri.io" target="_blank" class="hover:text-gray-300 transition-all duration-200">
                    ...
                    <Link href="https://github.com/nestrilabs/nestri" target="_blank" class="hover:text-gray-300 transition-all duration-200 -mt-0.5">
                    ...
                    <Link href="https://discord.com/invite/Y6etn3qKZ3" target="_blank" class="hover:text-gray-300 transition-all duration-200 -mt-0.5">
