                        ...
                        <div class="w-full h-max md:pb-6">
                            <div class="gap-3 w-full flex flex-col">
                                ...
                                <div class="flex md:flex-row flex-col w-full gap-2 h-max md:items-center">
                                    ...
                                    <a href="https://github.com/nestrilabs/nestri#start" ref={v => docsLinkRef.value = v} class="w-max focus:ring-primary-500 hover:ring-primary-500 ring-gray-500 rounded-lg outline-none dark:text-gray-100/70 ring-2 text-sm h-max py-2 px-4 flex items-center transition-all duration-200 focus:bg-primary-100 focus:dark:bg-primary-900 focus:text-primary-500 text-gray-500 font-title font-bold justify-between">
