            ...
            <div class="flex flex-row justify-center relative items-center top-0 bottom-0">
                ...
                <div class="relative z-[5] animate-fade-in opacity-0 items-center flex">
                    ...
                    <Dropdown.Root onOpenChange$={onDialogOpen}>
                        ...
                        <Dropdown.Popover
                            class="bg-[hsla(0,0%,100%,.026)] min-w-[160px] max-w-[240px] backdrop-blur-md rounded-lg py-1 px-2 border border-[#2e2e2e] [box-shadow:0_8px_30px_rgba(0,0,0,.12)]">
                            <Dropdown.Group class="flex flex-col gap-1">
                                {actions.map((action, key) => (
                                    <Dropdown.Item
                                        key={action.label}
                                        class="leading-none text-sm items-center text-[#a0a0a0] hover:text-[#ededed] hover:bg-[hsla(0,0%,100%,.077)] flex px-2 gap-2 h-8 rounded-md cursor-pointer outline-none relative select-none  "
                                    ...
                                    >
                                        ...
                                        <div class="ml-auto">
                                            <kbd class="[text-shadow:hsla(0,0%,100%,.5)_0_0_1px] gap-1 items-center flex justify-center truncate px-1.5 text-xs min-w-5 h-5 rounded-[4px] bg-[hsla(0,0%,100%,.056)] text-[#a0a0a0]">
                                                {key + 1}
                                            </kbd>
                                        </div>
                                    </Dropdown.Item>
